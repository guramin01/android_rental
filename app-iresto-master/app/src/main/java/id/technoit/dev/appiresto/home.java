...
public class home extends AppCompatActivity
    ...
    TextView txtUserProfile, txtKeluar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManager.checkLoginHome();

        txtUserProfile = findViewById(R.id.txtUserProfile);
        txtKeluar = findViewById(R.id.txtKeluar);


        //memanggil method getuserdetail
        HashMap<String, String> user = sessionManager.getUserDetail();

        String Name = user.get(sessionManager.NAMA_USER);

        txtUserProfile.setText(" : " + Name);

        txtKeluar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                sessionManager.logoutHome();
            }
        });
