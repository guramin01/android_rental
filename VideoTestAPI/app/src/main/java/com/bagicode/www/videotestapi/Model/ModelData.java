...
public class ModelData {
    ...
    public static final String status = "ID_MOBIL";

    public ModelData(String id, String nama, String kelas_mhs, String gambar_mbl, String statusmbl) {
        this.idMobil = id;
        this.nama = nama;
     ...
     *     The Jenis
     */
    public void setStatusmbl(String statusmbl) {
        this.statusmbl = statusmbl;
    }
